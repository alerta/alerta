...
class TestAlert(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.SERVICE = ['Common']
        self.TEXT = 'Node is not responding to $W ping'
        self.EVENT_TYPE = 'exceptionAlert'
        self.TAGS = {'location': '$A london', 'vendor':'cisco $B'}
    ...
    def test_alert_translate(self):
        ...
        alert.translate(self.trapvars)

        self.assertEquals(alert.text, 'Node is not responding to whiskey ping')
        self.assertEquals(alert.tags, self.EVENT)
