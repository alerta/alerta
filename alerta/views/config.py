...
def config():
    return jsonify({
        ...
        'azure_client_id': current_app.config['AZURE_CLIENT_ID'],
        'aws_region': current_app.config['AWS_REGION'],
        'cognito_domain': current_app.config['COGNITO_DOMAIN'],
        'cognito_client_id': current_app.config['COGNITO_CLIENT_ID'],
        ...
        'gitlab_client_id': current_app.config['GITLAB_CLIENT_ID'],
