    ...
    def is_blackout_period(self, alert):
        ...
        select = """
            ...
            WHERE start_time <= %(now)s AND end_time > %(now)s
              ...
              OR ( resource IS NULL AND service::text[] && %(service)s AND event IS NULL AND "group" IS NULL AND tags <@ %(tags)s )
              OR ( resource IS NULL AND service::text[] && %(service)s AND event IS NULL AND "group"=%(group)s AND tags='{}' )
              OR ( resource IS NULL AND service::text[] && %(service)s AND event IS NULL AND "group"=%(group)s AND tags <@ %(tags)s )
              OR ( resource IS NULL AND service::text[] && %(service)s AND event=%(event)s AND "group" IS NULL AND tags='{}' )
              OR ( resource IS NULL AND service::text[] && %(service)s AND event=%(event)s AND "group" IS NULL AND tags <@ %(tags)s )
              OR ( resource IS NULL AND service::text[] && %(service)s AND event=%(event)s AND "group"=%(group)s AND tags='{}' )
              OR ( resource IS NULL AND service::text[] && %(service)s AND event=%(event)s AND "group"=%(group)s AND tags <@ %(tags)s )
              ...
              OR ( resource=%(resource)s AND service::text[] && %(service)s AND event IS NULL AND "group" IS NULL AND tags='{}' )
              OR ( resource=%(resource)s AND service::text[] && %(service)s AND event IS NULL AND "group" IS NULL AND tags <@ %(tags)s )
              OR ( resource=%(resource)s AND service::text[] && %(service)s AND event IS NULL AND "group"=%(group)s AND tags='{}' )
              OR ( resource=%(resource)s AND service::text[] && %(service)s AND event IS NULL AND "group"=%(group)s AND tags <@ %(tags)s )
              OR ( resource=%(resource)s AND service::text[] && %(service)s AND event=%(event)s AND "group" IS NULL AND tags='{}' )
              OR ( resource=%(resource)s AND service::text[] && %(service)s AND event=%(event)s AND "group" IS NULL AND tags <@ %(tags)s )
              OR ( resource=%(resource)s AND service::text[] && %(service)s AND event=%(event)s AND "group"=%(group)s AND tags='{}' )
              OR ( resource=%(resource)s AND service::text[] && %(service)s AND event=%(event)s AND "group"=%(group)s AND tags <@ %(tags)s )
                )
        """
        data = vars(alert)
        data['now'] = now
