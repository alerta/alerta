        ...
        for tag in alert[alertid]['tags']:
            ...
            if tag.startswith('sms:') or tag.startswith('email:'):
                ...
                if tag.startswith('sms:') and tokens[who, 'sms'] > 0:
                    ...
                    tokens[who, 'sms'] -= 1
                    _Lock.release()
                    logging.info('Taken a sms token from %s, there are only %d left', who, tokens[who, 'sms'])
                ...
                if tag.startswith('email:') and tokens[who, 'email'] > 0:
                    ...
                    tokens[who, 'email'] -= 1
                    _Lock.release()
                    logging.info('Taken a email token from %s, there are only %d left', who, tokens[who, 'sms'])
