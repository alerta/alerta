    ...
    <?php require($DOCUMENT_ROOT . "includes/buttons.php"); ?>
      ...
      <div class="row show-grid">
        ...
        <div class="row show-grid">
          ...
          <div class="span3">
            <table class="table table-bordered table-condensed summary" id="none" data-label="none">
              <thead>
                <tr> <th colspan="6" id="none-status">-</th> </tr> 
              </thead>
              <tbody>
                <tr id="none-warnings" class="warnings">
                  <td id="none-critical">0</td>
                  <td id="none-major">0</td>
                  <td id="none-minor">0</td>
                  <td id="none-warning">0</td>
                  <td id="none-normal">0</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="span12">
          <table class="table table-bordered table-condensed" id="alert-details">
            <caption class="alerts-caption">
              LWP - <span id="alert-details-caption">R2</span> alert details
            </caption>
            <thead>
